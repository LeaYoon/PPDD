...
train_dataloader = dict(
    dataset=dict(
        ...
        type=dataset_type,
        data_root=data_root, 
        ann_file='annotations/rddphcv_coco_fmt_instance_test_sub.json',
        data_prefix=dict(img='test_sub1/'),
...
val_evaluator = dict(
    _delete_=True,
    type='CocoMetric',
    ann_file=data_root + 'annotations/rddphcv_coco_fmt_instance_test_sub.json',
    classwise=True,
    metric=['bbox', 'segm'],
    format_only=False,
    backend_args={{_base_.backend_args}})
