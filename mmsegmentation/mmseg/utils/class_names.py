...
def rddphcv_classes():
    """RDDPHCV class names for external use."""
    return ('Reflective', 'Verti-Edge', 'Corr-Shov-Disp', 'Rutt-Depress', 
                'Pothole-Ravel-Strip', 'Construction', 'Alligator', 'Non-crack'), 

def rddphcv_palette():
    """RDDPHCV class names for external use."""
    return [(128, 128, 128), (129, 127, 38), (120, 69, 125), (53, 125, 34), 
